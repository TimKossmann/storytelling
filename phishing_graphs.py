...
class Phishing_Graphs():
    ...
    def get_link_donut(self, darkmode=True):
        ...
        return self.update_donut_fig(fig, 'E269', "Link aufrufen", darkmode)
    ...
    def get_input_donut(self, darkmode=True):
        ...
        return self.update_donut_fig(fig, '2328_color', "Daten eingeben", darkmode)
    ...
    def get_attach_donut(self, darkmode=True):
        ...
        return self.update_donut_fig(fig, '1F4CE', "Anhang öffnen", darkmode)

    def update_donut_fig(self, fig, img_name, txt, darkmode):
        if darkmode:
            color = 'white'
